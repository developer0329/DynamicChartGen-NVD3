nv.models.lineChart = function() {
    ...
    var margin = {top: 30, right: 60, bottom: 50, left: 60}
        , margin2 = {top: 0, right: 60, bottom: 20, left: 60}
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            gEnter.append('g').attr('class', 'nv-legendWrap').style("pointer-events",interactivePointerEvents);
            ...
            var getAvgLineY = function(d) {
                ...
                var yVal = y(v);
                //if (yVal < 0) return 0;
                if (yVal > availableHeight1) return availableHeight1;
                return yVal;
            };
            ...
            avgLines.enter()
				...
				.attr('id',function(d){return "avg-line-" + d.key;})
                .attr('x1',0)
            ...
            avgLines
                .style('stroke-opacity',function(d){
                    ...
                    if (yVal < 0 || yVal > availableHeight1) return 0;
                    return 1;
                })
                .attr('x1',0)
                .attr('x2',availableWidth)
